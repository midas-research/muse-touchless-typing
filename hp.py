...
#RNN related
inputDim = 198 + 120 #Embedding dimension (video embedding + sensor embedding)
hiddenDim = 512
rnn_layers = 4
batch_size = 4
bidirectional = True
...
data_path = '/media/data_dump_2/Pranay/dataset/main_preprocessing/museproject/dataset_muse_single' #folder contained numpy embedding matrix for sensor data.
video_data_path = '../../user_embeddings' #folder containing numpy embedding matrix for video data.
model_path = '' #reloading file path
stats = '/media/data_dump_2/Pranay/dataset/main_preprocessing/museproject/muse/mfcc_stats.pkl' #sensor stats file for normalization uses
...
dataset_split = {
    'train' : ['hitkul1808', 'anushka0110', 'shivam1808', 'siddharth2208', 'gyanesh0909', 'prakhar2308', 'ashwat2508', 'pakhi2408', 'aayush0209', 'ishaan0309', 'lakshya0109', 'abhishek2709', 'aakash0910', 'apoorv0209', 'suril2408'],
    'val': ['harsh2509', 'shahid3108'],
    'test' : ['shagun0409', 'sakshi0109', 'ritwik0109', 'shivangi1908']
}
...
train_words = train_words+val_words+test_words
